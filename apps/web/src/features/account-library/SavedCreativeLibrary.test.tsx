...
describe('saved creative libraries', () => {
  ...
  it('shows character empty state, use handoff, reference image, and confirmed deletion', () => {
    ...
    const view = render(
      <StudioDesignProvider>
        <SavedCharacterLibrary items={[]} repository={repository} onUse={onUse} />
      </StudioDesignProvider>,
    );
    ...
    view.rerender(
      <StudioDesignProvider>
        <SavedCharacterLibrary items={[character]} repository={repository} onUse={onUse} />
      </StudioDesignProvider>,
    );
  ...
  it('shows outfit empty state, use handoff, and declines deletion', () => {
    ...
    const view = render(
      <StudioDesignProvider>
        <SavedOutfitLibrary items={[]} repository={repository} onUse={onUse} />
      </StudioDesignProvider>,
    );
    ...
    view.rerender(
      <StudioDesignProvider>
        <SavedOutfitLibrary items={[outfit]} repository={repository} onUse={onUse} />
      </StudioDesignProvider>,
    );
