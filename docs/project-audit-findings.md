...
At this audit the qualification validator reports **0/7 provider/local** and **0/45 physical**
...
| --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ARCH-001`, `DOC-001`, `TEST-004`, `TEST-007` — live provider qualification                                     | Decart clock/end handling, safe errors, provider finalization order, and synthetic journeys are implemented. Live entitlement, exact-model behavior, output, retention, and five-minute boundary evidence is absent.   | Pass all seven provider/local rows for the exact candidate: Local no-key, Lucy 2.5, VTO 3, ElevenLabs, OpenAI, BFL, and operator-only Wiro.                          |
