...
| Remove eligible saved voice       | ElevenLabs receives the saved voice ID only after fresh bookmark/ownership/community validation and explicit confirmation; this mutates provider account-library state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- Saved/Browse criteria and page caches are session/process memory only. Adding or removing a
  voice changes the configured ElevenLabs account library; reload or local cleanup does not undo
