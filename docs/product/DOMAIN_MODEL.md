...
| **Recording session**                   | The live camera stage lifecycle: camera off by default, explicit start, optional live AI, take review — and, from take review, a retake that discards the take and asks for the camera again, so the loop closes without the stream ever outliving review.                                                                                                                                                                                                                                             |
