...
| ----------------------------------------------------------- | ------- | ------------------- | ----------------------------------------------------------------------------- | ------------- |
| [Project README](../README.md)                              | Current | Product/engineering | Product overview, setup, configuration, commands, and release posture         | 2026-08-08    |
...
| [Architecture](ARCHITECTURE.md)                             | Current | Engineering         | Dependency, ownership, lifecycle, persistence, API, and deployment boundaries | 2026-08-08    |
