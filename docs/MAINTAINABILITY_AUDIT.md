...
| `apps/web/src/studio`             | Studio composition and cross-feature handoff. **Not runtime-only** (corrected 2026-09-08): six shell-lifetime modules import from here across 31 imports, and the code is right — a Character or Outfit workflow outlives the capture runtime |
