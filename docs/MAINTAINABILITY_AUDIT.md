...
| `apps/web/src/studio`             | Studio composition and cross-feature handoff. **Not runtime-only** (corrected 2026-09-08): the six non-test modules under `app/shell` all import from here, in 24 import statements, and the code is right — a Character or Outfit workflow outlives the capture runtime |
