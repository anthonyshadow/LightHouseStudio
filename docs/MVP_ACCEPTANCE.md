...
| `bun run test:visual`                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Pass and reviewed at the required platform baseline      | **Pass** — Darwin 35/35; pinned `mcr.microsoft.com/playwright:v1.62.1-noble` Linux 35/35; 35 × 2 baseline prune check with no leftovers; every changed baseline visually inspected. _Recorded against the 35-case matrix; it is now 50 cases, and the Linux set is 31 — the nine H.264 scenarios are skipped there. See [screenshot coverage](screenshot-test-coverage.md)._ |
