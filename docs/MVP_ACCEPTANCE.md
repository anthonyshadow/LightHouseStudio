...
| 3   | Quick Start creates a standalone Project; Campaign detail creates a Campaign Project with minimal metadata.                                                                   | `ProjectRouteSurface.test.tsx`; `CampaignRouteSurface.test.tsx`; `e2e/app-routing.spec.ts`.                                                                                      | **Pass**        |
...
| 12  | Bounded history, exact old-Version preview/use/download, retained Project content, and Unassigned Content work.                                                               | `ProjectHistorySection.test.tsx`; `VideoGallery.test.tsx`; Project history/output route tests; exact-Version browser journey.                                                    | **Pass**        |
| 13  | Campaigns, Projects, open Project Studio, Saved Videos, and reusable libraries navigate coherently without silent loss.                                                       | `StudioExitGuard.test.tsx`; shared-stage and Back/Forward Playwright cases; Project/library exit and deep-link tests.                                                            | **Pass**        |
...
- legacy content remains usable and is **Unassigned Content** without a trustworthy output relation;
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bun run quality`                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Pass                                                     | **Pass** — 231 files passed, 4 skipped; 1,669 tests passed, 7 skipped; typechecks, Storybook typing, ESLint, Prettier, knip, module/script/document/retired checks, application/package/API builds, build manifest, and Storybook build passed |
...
| `bun run test:visual`                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Pass and reviewed at the required platform baseline      | **Pass** — Darwin 31/31; pinned `mcr.microsoft.com/playwright:v1.62.1-noble` Linux 31/31; 31 × 2 baseline prune check with no leftovers; every changed baseline visually inspected                                                             |
...
These automated results were recorded on 2026-08-14 in the local macOS environment; visual
verification additionally used the pinned Linux image named above. No live provider, Neon, R2,
