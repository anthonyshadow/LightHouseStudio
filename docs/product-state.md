...
| **PROD-006** | For the controlled pilot, disclose detach-versus-delete, isolate each tester's data, and verify whole-dataset operator retirement. Self-serve needs a usable erase-all path; public needs relationship-aware deletion.     | SEC-004                             |
| **PROD-007** | Decide the pilot's participant/provider access, usage limits, failed-request allowance, moderation/refusal policy, and support owner. Do not build payments yet.                                                           | SEC-002, SEC-005                    |
...
| **PROD-009** | If VTO is included, guide users toward one garment and a plain background and make no fit, sizing, or purchase-accuracy claim.                                                                                             | UX content guidance                 |
| **PROD-010** | Make image-generation provider contact, potential cost, and retained output clear at the generation action.                                                                                                                | SEC-005                             |
| **PROD-011** | Add action-first subtitles and verbs, then test terminology. Do not wholesale rename the IA before observing users.                                                                                                        | UX-004, UX-005                      |
...
| **PROD-014** | For the controlled pilot, use moderated observation and content-free local exports. Network analytics are not a pilot prerequisite.                                                                                        | Privacy-safe instrumentation        |
| **PROD-015** | Show clip duration and provider-usage context at ElevenLabs Apply. Do not invent a confirmation threshold without cost evidence.                                                                                           | SEC-006                             |
